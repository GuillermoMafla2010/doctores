...
module.exports = (sequelize, DataTypes) => {
  ...
  Especialidades.associate = function(models) {
    ...
    Especialidades.hasMany(models.citas,{
      foreignKey: 'especialidad_id'
      ,targetKey: 'especialidad_id',
    })*/

    Especialidades.belongsToMany(models.Usuarios,{through:models.usuariosespecialidades , foreignKey:'especialidad_id'});
    Especialidades.hasMany(models.citas,{foreignKey:'especialidad_id'})
